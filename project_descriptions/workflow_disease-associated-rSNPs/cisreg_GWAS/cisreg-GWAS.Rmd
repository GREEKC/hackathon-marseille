...
gwasrestoutput <- fromJSON(gwascatalog.studies.urlrest, content_type("application/json"))
...
for (i in 1:numberOfRows){
  studyToInspect <- df[i, "studies.accessionId"]
  
  ## URL to the GWAS REST API query for the disease
gwascatalog.disease.urlrestsnps <- paste(
  sep = "", 
  "https://www.ebi.ac.uk/gwas/rest/api/studies/", studyToInspect, "/snps")
message("GWAS catalog SNPs link\t", gwascatalog.disease.urlrestsnps)
